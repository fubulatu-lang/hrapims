  ...
  return (
    <>
      <TopBar
        ...
        trailing={
          <IconButton icon={nextTheme.icon} label={`Switch to ${nextTheme.label} theme`} onClick={() => setTheme(nextTheme.value)} />
        }
      />
      <div className="main-content">
        ...
        <Card variant="elevated">
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            {isAdmin && <Button variant="tonal" size="sm" icon="history" onClick={() => goTo('activity')}>View Logs</Button>}
            {isAdmin && <Button variant="tonal" size="sm" icon="groups" onClick={() => goTo('staffManage')}>Manage Staff</Button>}
